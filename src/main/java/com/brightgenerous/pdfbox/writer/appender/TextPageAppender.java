...
public class TextPageAppender extends PositionPageAppender {
    ...
    public TextPageAppender(AppenderFlag flag, AppenderAlign align, AppenderVertical vertical,
    ...
    protected String getText(int start, int pages, int page) {
        return MessageFormat.format(getFormat(), Integer.valueOf(start + page), null,
                Integer.valueOf(start), Integer.valueOf(pages), Integer.valueOf(page));
    }
